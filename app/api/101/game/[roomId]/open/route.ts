...
import type { TileColor, TileNumber, SeatPosition } from '@/lib/101/game/constants'
...
export async function POST(
  ...
  try {
    ...
    const { tileIds } = await request.json() // Array of tile IDs forming a single set
    ...
    // Check if player has opened before (check opened_sets for this player)
